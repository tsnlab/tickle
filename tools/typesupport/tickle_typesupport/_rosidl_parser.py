# ======================================================================================
# VENDORED - do not edit. Re-vendor to update.
#
#   Source : ros2/rosidl  rosidl_adapter/rosidl_adapter/parser.py
#   Ref    : jazzy @ 85fa592b698b0f665e3120f48fac0d35e2f7d8a4
#   URL    : https://raw.githubusercontent.com/ros2/rosidl/85fa592b698b0f665e3120f48fac0d35e2f7d8a4/rosidl_adapter/rosidl_adapter/parser.py
#
# This is the canonical ROS 2 .msg / .srv grammar parser (stdlib-only: os, re, sys, textwrap).
# We use parse_message_string() / parse_service_string() -> MessageSpecification /
# ServiceSpecification only; type resolution of nested `pkg/Type` fields is done by
# tickle_typesupport.resolve, not here.
#
# Licensed under the Apache License 2.0 (header below is the upstream file's own). Included in
# this GPL-3.0-or-later project as a build-time tool only - it is never linked into libtickle.
# ======================================================================================
