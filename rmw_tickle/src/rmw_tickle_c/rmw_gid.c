...
rmw_ret_t rmw_compare_gids(const rmw_gid_t* gid1, const rmw_gid_t* gid2, int* result) {
...
rmw_ret_t rmw_get_gid_for_subscription(const rmw_subscription_t* subscription, rmw_gid_t* gid) {
...
rmw_ret_t rmw_get_gid_for_service(const rmw_service_t* service, rmw_gid_t* gid) {
