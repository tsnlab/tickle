...
// a .msg with a nested field or .srv - not yet supported, see rosidl_typesupport_tickle_c/PLAN.md
// notes) - never asserts/crashes on a mismatched type_support the way the lower-level dispatch
// functions themselves might.
