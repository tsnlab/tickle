...
// `reverse` = the packet was written by a peer of the opposite byte order (tt_is_reverse_endian
// on its tt_Header) - the 2-byte length prefix is then byte-swapped on read.
