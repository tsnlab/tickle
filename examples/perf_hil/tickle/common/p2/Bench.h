...
_Static_assert(sizeof(struct BenchData) == 1388, "BenchData must match its CDR-4 wire size - ABI mismatch");
#define BenchData_FITS_ONE_DATAGRAM (1388 <= tt_MAX_BUFFER_LENGTH)
