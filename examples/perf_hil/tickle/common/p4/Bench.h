...
_Static_assert(sizeof(struct BenchData) == 2800, "BenchData must match its CDR-4 wire size - ABI mismatch");
#define BenchData_FITS_ONE_DATAGRAM (2800 <= tt_MAX_BUFFER_LENGTH)
