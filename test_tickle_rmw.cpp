  ...
  public:
    TickLETestNode() : Node("tickle_test_node") {
        ...
        subscription_ = this->create_subscription<std_msgs::msg::String>(
            "test_topic", 10, std::bind(&TickLETestNode::topic_callback, this, std::placeholders::_1));

        // Create timer to publish messages
        timer_ = this->create_wall_timer(1s, std::bind(&TickLETestNode::timer_callback, this));
